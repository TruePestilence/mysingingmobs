...
public class PotbellyRenderer extends GeoEntityRenderer<PotbellyEntity> {
    ...
    @Override
    public RenderType getRenderType(PotbellyEntity animatable, float partialTick, PoseStack poseStack, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, int packedLight, ResourceLocation texture) {
