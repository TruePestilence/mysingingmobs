...
public class PotbellyEntity extends PathfinderMob implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public PotbellyEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.potbelly.idle", ILoopType.EDefaultLoopTypes.LOOP));
