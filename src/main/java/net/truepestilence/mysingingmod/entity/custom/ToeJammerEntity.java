...
public class ToeJammerEntity extends PathfinderMob implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public ToeJammerEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.toejammer.idle", ILoopType.EDefaultLoopTypes.LOOP));
    ...
    protected InteractionResult mobInteract(Player pPlayer, InteractionHand pHand) {
        ...
        if(stack.getItem() == ModItems.MONSTER_SIGIL.get()) {
            ...
            if(!nbt.contains("entity")) {
                ...
                nbt.putString("entity", "Toe Jammer");
                stack.setTag(nbt);
