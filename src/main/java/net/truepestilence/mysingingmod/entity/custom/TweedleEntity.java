...
public class TweedleEntity extends PathfinderMob implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public TweedleEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.tweedle.idle", ILoopType.EDefaultLoopTypes.LOOP));
